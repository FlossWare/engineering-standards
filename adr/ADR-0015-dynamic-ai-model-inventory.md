...
- Does not define consensus diversity units ([ADR-0012](ADR-0012-multi-model-consensus-quality-gates.md)).
...
Here **provider** means an **integration adapter** (endpoint, auth, call format), consistent with [ADR-0002](ADR-0002-ai-provider-abstraction.md).
